 ...
 */
    ...
    public function fields(NovaRequest $request)
    {
        ...
        return [
            ...
            Select::make('Wappalyzer', 'is_wappalyzer')
            ->options([
                'done' => 'DONE',
                'fail'    => 'FAIL',
                'scraping' => 'SCRAPING',
            ...
            Select::make('Seo Analyzer', 'is_seo_analyzer')
            ->options([
                'done' => 'DONE',
                'fail'    => 'FAIL',
                'scraping' => 'SCRAPING',
            ...
            Select::make('Ip Location', 'is_ip_location')
            ->options([
                'done' => 'DONE',
                'fail'    => 'FAIL',
                'scraping' => 'SCRAPING',
            ...
            Select::make('Screenshot', 'is_screenshot')
            ->options([
                'done' => 'DONE',
                'fail'    => 'FAIL',
                'scraping' => 'SCRAPING',
